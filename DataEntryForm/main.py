...
def enter_data():
    ...
    if av == "Accepted":
        ...
        if firstname and lastname:
            ...
            # Create Table
            conn = sqlite3.connect('DataEntryForm/dataentryform.db')
            ...
            tkinter.messagebox.showwarning(title="Error",message="First and last name is required.")
    else:
        tkinter.messagebox.showwarning(title="Error",message="Accept T&C.")
...
nationality_combobox = ttk.Combobox(user_info_frame,values=["Africa","Antarctica","Europe","North America","South America"])
...
# Saving course info
courses_frame = tkinter.LabelFrame(frame,text="Registration Status")
...
terms_check = tkinter.Checkbutton(terms_frame,text="I accept the T & C",variable=accept_var,onvalue="Accepted",offvalue="Not Accepted")
